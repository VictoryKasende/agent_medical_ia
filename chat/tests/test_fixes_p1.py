...
from chat.models import DataExportJob, MedecinAvailability
...
class QuickTestFixesP1(APITestCase):
    ...
    def setUp(self):
        ...
        self.patient = User.objects.create_user(
            username="patient_quick", email="patient@quick.com", password="testpass", role="patient"
        )

        self.medecin = User.objects.create_user(
            username="medecin_quick", email="medecin@quick.com", password="testpass", role="medecin"
        )

        self.admin = User.objects.create_superuser(username="admin_quick", email="admin@quick.com", password="testpass")
    ...
    def test_models_creation_basic(self):
        ...
        try:
            ...
            availability = MedecinAvailability.objects.create(
                medecin=self.medecin, day_of_week=1, start_time="09:00", end_time="17:00"
            )
    ...
    def test_api_urls_resolve(self):
        ...
        try:
            urls = ["chat_api:availability-list", "chat_api:export-list"]
