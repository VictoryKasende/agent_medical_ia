    ...
    class Meta:
        ...
        widgets = {
            ...
            "date_naissance": forms.DateInput(
                attrs={"type": "date", "class": "w-full px-4 py-2 border rounded-lg bg-gray-50", "id": "date-naissance"}
            ),
            ...
            "temperature": forms.NumberInput(
                attrs={"class": "w-full px-4 py-2 border rounded-lg bg-gray-50", "step": "0.1", "min": 30, "max": 45}
            ),
            "spo2": forms.NumberInput(
                attrs={"class": "w-full px-4 py-2 border rounded-lg bg-gray-50", "min": 50, "max": 100}
            ),
            "poids": forms.NumberInput(
                attrs={"class": "w-full px-4 py-2 border rounded-lg bg-gray-50", "min": 1, "max": 300}
            ),
            "tension_arterielle": forms.TextInput(
                attrs={"class": "w-full px-4 py-2 border rounded-lg bg-gray-50", "placeholder": "ex: 120/80"}
            ),
            "pouls": forms.NumberInput(
                attrs={"class": "w-full px-4 py-2 border rounded-lg bg-gray-50", "min": 30, "max": 200}
            ),
            "frequence_respiratoire": forms.NumberInput(
                attrs={"class": "w-full px-4 py-2 border rounded-lg bg-gray-50", "min": 5, "max": 60}
            ),
            # Présence à la consultation
            "patient": forms.CheckboxInput(attrs={"class": "h-5 w-5 text-blue-600"}),
            "proche": forms.CheckboxInput(attrs={"class": "h-5 w-5 text-blue-600"}),
            "soignant": forms.CheckboxInput(attrs={"class": "h-5 w-5 text-blue-600"}),
            "medecin": forms.CheckboxInput(attrs={"class": "h-5 w-5 text-blue-600"}),
            "autre": forms.CheckboxInput(attrs={"class": "h-5 w-5 text-blue-600"}),
            "proche_lien": forms.TextInput(
                attrs={"class": "ml-2 px-2 py-1 border rounded w-24", "placeholder": "lien"}
            ),
            "soignant_role": forms.TextInput(
                attrs={"class": "ml-2 px-2 py-1 border rounded w-24", "placeholder": "rôle"}
            ),
            "autre_precisions": forms.TextInput(
                attrs={"class": "ml-2 px-2 py-1 border rounded w-24", "placeholder": "préciser"}
            ),
            # Anamnèse
            "motif_consultation": forms.Textarea(
                attrs={"class": "w-full px-4 py-2 border rounded-lg bg-gray-50", "rows": 3}
            ),
            "histoire_maladie": forms.Textarea(
                attrs={"class": "w-full px-4 py-2 border rounded-lg bg-gray-50", "rows": 5}
            ),
            "maison_medicaments": forms.CheckboxInput(attrs={"class": "h-5 w-5 text-blue-600"}),
            "pharmacie_medicaments": forms.CheckboxInput(attrs={"class": "h-5 w-5 text-blue-600"}),
            "centre_sante_medicaments": forms.CheckboxInput(attrs={"class": "h-5 w-5 text-blue-600"}),
            "hopital_medicaments": forms.CheckboxInput(attrs={"class": "h-5 w-5 text-blue-600"}),
            "medicaments_non_pris": forms.CheckboxInput(attrs={"class": "h-5 w-5 text-blue-600"}),
            "details_medicaments": forms.Textarea(
                attrs={"class": "w-full px-4 py-2 border rounded-lg bg-gray-50", "rows": 2}
            ),
            "cephalees": forms.CheckboxInput(attrs={"class": "h-5 w-5 text-blue-600"}),
            "vertiges": forms.CheckboxInput(attrs={"class": "h-5 w-5 text-blue-600"}),
            "palpitations": forms.CheckboxInput(attrs={"class": "h-5 w-5 text-blue-600"}),
            "troubles_visuels": forms.CheckboxInput(attrs={"class": "h-5 w-5 text-blue-600"}),
            "nycturie": forms.CheckboxInput(attrs={"class": "h-5 w-5 text-blue-600"}),
            # Antécédents médicaux
            "hypertendu": forms.CheckboxInput(attrs={"class": "h-5 w-5 text-blue-600"}),
            "diabetique": forms.CheckboxInput(attrs={"class": "h-5 w-5 text-blue-600"}),
            "epileptique": forms.CheckboxInput(attrs={"class": "h-5 w-5 text-blue-600"}),
            "trouble_comportement": forms.CheckboxInput(attrs={"class": "h-5 w-5 text-blue-600"}),
            "gastritique": forms.CheckboxInput(attrs={"class": "h-5 w-5 text-blue-600"}),
            "tabac": forms.Select(attrs={"class": "w-full px-4 py-2 border rounded-lg bg-gray-50"}),
            "alcool": forms.Select(attrs={"class": "w-full px-4 py-2 border rounded-lg bg-gray-50"}),
            "activite_physique": forms.Select(attrs={"class": "w-full px-4 py-2 border rounded-lg bg-gray-50"}),
            "activite_physique_detail": forms.TextInput(
                attrs={
                    "class": "w-full mt-2 px-4 py-2 border rounded-lg bg-gray-50",
                    "placeholder": "Quelles activités?",
                }
            ),
            "alimentation_habituelle": forms.Textarea(
                attrs={"class": "w-full px-4 py-2 border rounded-lg bg-gray-50", "rows": 2}
            ),
            "allergie_medicamenteuse": forms.CheckboxInput(attrs={"class": "h-5 w-5 text-blue-600"}),
            "medicament_allergique": forms.TextInput(
                attrs={
                    "class": "ml-4 px-4 py-2 border rounded-lg bg-gray-50 flex-grow",
                    "placeholder": "Médicament allergique",
                }
            ),
            "familial_drepanocytaire": forms.CheckboxInput(attrs={"class": "h-5 w-5 text-blue-600"}),
            "familial_diabetique": forms.CheckboxInput(attrs={"class": "h-5 w-5 text-blue-600"}),
            "familial_obese": forms.CheckboxInput(attrs={"class": "h-5 w-5 text-blue-600"}),
            "familial_hypertendu": forms.CheckboxInput(attrs={"class": "h-5 w-5 text-blue-600"}),
            "familial_trouble_comportement": forms.CheckboxInput(attrs={"class": "h-5 w-5 text-blue-600"}),
            "lien_pere": forms.CheckboxInput(attrs={"class": "h-5 w-5 text-blue-600"}),
            "lien_mere": forms.CheckboxInput(attrs={"class": "h-5 w-5 text-blue-600"}),
            "lien_frere": forms.CheckboxInput(attrs={"class": "h-5 w-5 text-blue-600"}),
            "lien_soeur": forms.CheckboxInput(attrs={"class": "h-5 w-5 text-blue-600"}),
            "evenement_traumatique": forms.RadioSelect(attrs={"class": "h-5 w-5 text-blue-600"}),
            "trauma_divorce": forms.CheckboxInput(attrs={"class": "h-5 w-5 text-blue-600"}),
            "trauma_perte_parent": forms.CheckboxInput(attrs={"class": "h-5 w-5 text-blue-600"}),
            "trauma_deces_epoux": forms.CheckboxInput(attrs={"class": "h-5 w-5 text-blue-600"}),
            "trauma_deces_enfant": forms.CheckboxInput(attrs={"class": "h-5 w-5 text-blue-600"}),
            ...
            "commentaire_medecin": forms.Textarea(
                attrs={"class": "w-full px-4 py-2 border rounded-lg bg-gray-50", "rows": 2}
            ),
        }
