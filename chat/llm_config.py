...
#     raise ValueError("⚠️ Toutes les clés API (OpenAI, Anthropic, Google) doivent être définies dans le fichier .env")
#
# # Instanciation des modèles LLM
# gpt4 = ChatOpenAI(
#     model="gpt-4-1106-preview",  # ou "gpt-4.1" selon ta version
#     temperature=0.3,
#     openai_api_key=openai_key
# )
#
# claude = ChatAnthropic(
#     model="claude-3-opus-20240229",  # modèle Claude 3 le plus puissant
#     temperature=0.3,
