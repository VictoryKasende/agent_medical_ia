    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('present', models.CharField(choices=[('patient', 'Patient'), ('proche', 'Proche aidant'), ('soignant', 'Soignant'), ('medecin', 'Médecin'), ('autre', 'Autre')], default='patient', max_length=20)),
                ...
                ('lieu_medicaments', models.CharField(blank=True, choices=[('maison', 'À la maison'), ('pharmacie', 'Pharmacie'), ('centre', 'Centre de santé'), ('hopital', 'Hôpital'), ('ici', 'Ici'), ('rien', 'Rien pris')], default='maison', max_length=20, null=True)),
                ...
                ('medecin_validateur', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='consultations_validees', to='authentication.customuser')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='conversation',
            name='user',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='conversations', to='authentication.customuser'),
        ),
    ]
