...
INSTALLED_APPS = [
    ...
    'drf_spectacular',
    # 3rd party API framework & schema
    'rest_framework',
    'rest_framework_simplejwt',
    'drf_spectacular',
    # API & documentation
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'Agent Medical IA API',
    'DESCRIPTION': 'API REST pour gestion consultations, conversations IA, utilisateurs.',
    'VERSION': '1.0.0',
    'SERVE_INCLUDE_SCHEMA': False,
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'MEDIAI API',
    'DESCRIPTION': 'API REST pour MEDIAI (consultations médicales assistées par IA).',
    'VERSION': '1.0.0',
    'SERVE_INCLUDE_SCHEMA': False,
}
